<?php
    ...
    class SQLiDB extends PDO {
        function __construct(){
            parent::__construct($GLOBALS['dbtype'] . ':' . $GLOBALS['reg_db_name'], $GLOBALS['usr'], $GLOBALS['pass'], array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES UTF8; SET CHARACTER SET UTF8"));
    ...
    class ContentDB extends PDO {
        function __construct(){
            parent::__construct($GLOBALS['dbtype'] . ':' . $GLOBALS['content_db_name'], $GLOBALS['usr'], $GLOBALS['pass'], array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
